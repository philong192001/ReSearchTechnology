...
{
    public class CashLog : BaseAccountCommand
    {
    ...
    public class CashLog10Field
    {
        public CashLog10Field(DateTime? updateTime, DateTime? createDate, DateTime? tranDate, string? refId, string? subId, byte? status, byte? updateType, string clientCode, string? stockCode, int businessType)
        {
